...
export default function Pages ({ data, setData }) {
    ...
    const _save_ = async() => {
        ...
        setLoader(true);
        const response = await api('content/update', {...data, ...fix_files(data)});
        setLoader(false);
    ...
    useEffect(() => {
        ...
        document.title = `${config.text.pages} | ${config.text.content_manager}`;
                        ...
                        <div className="w-full grid grid-cols-1 gap-5">
                            ...
                            <div className='panel relative pb-6'>
                                <div className="w-full grid grid-cols-1 sm:grid-cols-1 gap-y-6 gap-x-10 px-2 pb-2">
                                    <Elements element='slider' name='hero_section' value={data.hero_section || []} slider={data.slider} onChange={(e) => setData({...data, slider: e, ...e})}/>
                                </div>
                            </div>
                            <div className='panel relative pb-6'>
