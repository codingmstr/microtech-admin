            ...
            general={[
                {
                    ...
                    inputs: [
                        {element: 'select_menu', name: 'product_id', label: 'product', class: 'flex', children: 'products', readOnly: id, required: !id, value: params.product_id, translate: true},
                        {element: 'select_menu', name: 'client_id', label: 'client', class: 'flex', children: 'clients', readOnly: id, value: params.client_id},
                        {element: 'select', type: 'rate', name: 'rate', class: 'flex'},
                    ],
                },
                {
