    ...
    return (
        ...
        <div>
            ...
            <div className="fixed bottom-6 z-50 ltr:right-6 rtl:left-6">
                {
                    button &&
                    <button type="button" onClick={() => {document.body.scrollTop=0;document.documentElement.scrollTop=0;}} className="btn btn-outline-primary animate-pulse rounded-full bg-[#fafafa] p-2 dark:bg-[#060818] dark:hover:bg-primary">
