                            ...
                            <div className="mb-3 rounded-md border border-dashed border-white-light px-4 py-5 dark:border-[#1b2e4b]">
                                ...
                                <div className="mt-5 flex justify-between items-center gap-3 text-primary">
                                    ...
                                    <label className="mb-0 inline-flex pointer">
                                        <input type="radio" checked={config.nav === 'navbar-sticky'} value="navbar-sticky" className="form-radio" onChange={() => dispatch(actions.toggle_nav('navbar-sticky'))}/>
                                        <span className='px-1'>{config.text.sticky}</span>
                                    </label>

                                    <label className="mb-0 inline-flex pointer">
                                        <input type="radio" checked={config.nav === 'navbar-floating'} value="navbar-floating" className="form-radio" onChange={() => dispatch(actions.toggle_nav('navbar-floating'))}/>
                                        <span className='px-1'>{config.text.floating}</span>
                                    </label>

                                    <label className="mb-0 inline-flex pointer">
                                        <input type="radio" checked={config.nav === 'navbar-static'} value="navbar-static" className="form-radio" onChange={() => dispatch(actions.toggle_nav('navbar-static'))}/>
