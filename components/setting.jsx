    ...
    return (
        ...
        <div>
            ...
            <div className='settings'>
                ...
                <nav className={`${(config.setting && 'ltr:!right-0 rtl:!left-0') || ''} select-none fixed top-0 bottom-0 z-[51] w-full max-w-[400px] bg-panel transition-all duration-300 ltr:-right-[400px] rtl:-left-[400px] dark:bg-panel-dark ltr:border-l rtl:border-r border-border dark:border-border-dark`}>
                    
                    <div className="h-full overflow-hidden">

                        <div className="flex justify-between items-center relative px-5 py-4 border-b border-border dark:border-border-dark">
                        ...
                        <div className="h-[calc(100%_-_65px)] overflow-y-auto overflow-x-hidden p-5">
                            ...
                            <div className="mb-3 rounded-md border border-border py-6 px-5 dark:border-border-dark">
                                ...
                                <div className="mt-5 grid grid-cols-3 gap-2">
                                    ...
                                    <button type="button" className={`${config.theme === 'light' ? 'btn-primary' : 'border border-border dark:border-border-dark dark:text-white-light/75 hover:!border-primary/30 hover:!text-primary hover:bg-primary/20'} btn !shadow-none`} onClick={() => dispatch(actions.toggle_theme('light'))}>
                                    ...
                                    <button type="button" className={`${config.theme === 'dark' ? 'btn-primary' : 'border border-border dark:border-border-dark dark:text-white-light/75 hover:!border-primary/30 hover:!text-primary hover:bg-primary/20'} btn !shadow-none`} onClick={() => dispatch(actions.toggle_theme('dark'))}>
                                    ...
                                    <button type="button" className={`${config.theme === 'system' ? 'btn-primary' : 'border border-border dark:border-border-dark dark:text-white-light/75 hover:!border-primary/30 hover:!text-primary hover:bg-primary/20'} btn !shadow-none`} onClick={() => dispatch(actions.toggle_theme('light'))}>
                            ...
                            <div className="mb-3 rounded-md border border-border py-6 px-5 dark:border-border-dark">
                                ...
                                <div className="mt-5 grid grid-cols-3 gap-2">
                                    ...
                                    <button type="button" className={`${config.menu === 'horizontal' ? 'btn-primary' : 'border border-border dark:border-border-dark dark:text-white-light/75 hover:!border-primary/30 hover:!text-primary hover:bg-primary/20'} btn !shadow-none`} onClick={() => dispatch(actions.toggle_menu('horizontal'))}>
                                        {config.text.horizontal}
                                    </button>

                                    <button type="button" className={`${config.menu === 'vertical' ? 'btn-primary' : 'border border-border dark:border-border-dark dark:text-white-light/75 hover:!border-primary/30 hover:!text-primary hover:bg-primary/20'} btn !shadow-none`} onClick={() => dispatch(actions.toggle_menu('vertical'))}>
                                        {config.text.vertical}
                                    </button>

                                    <button type="button" onClick={() => dispatch(actions.toggle_menu('collapsible-vertical'))} className={`${config.menu === 'collapsible-vertical' ? 'btn-primary' : 'border border-border dark:border-border-dark dark:text-white-light/75 hover:!border-primary/30 hover:!text-primary hover:bg-primary/20'} btn !shadow-none`}>
                            ...
                            <div className="mb-3 rounded-md border border-border py-6 px-5 dark:border-border-dark">
                                ...
                                <div className="mt-5 flex gap-2">
                                    ...
                                    <button type="button" onClick={() => dispatch(actions.toggle_layout('boxed-layout'))} className={`${config.layout === 'boxed-layout' ? 'btn-primary' : 'border border-border dark:border-border-dark dark:text-white-light/75 hover:!border-primary/30 hover:!text-primary hover:bg-primary/20'} btn flex-auto !shadow-none`}>
                                        {config.text.box}
                                    </button>

                                    <button type="button" className={`${config.layout === 'full' ? 'btn-primary' : 'border border-border dark:border-border-dark dark:text-white-light/75 hover:!border-primary/30 hover:!text-primary hover:bg-primary/20'} btn flex-auto !shadow-none`} onClick={() => dispatch(actions.toggle_layout('full'))}>
                                        {config.text.full}
                                    </button>
                            ...
                            <div className="mb-3 rounded-md border border-border py-6 px-5 dark:border-border-dark">
                                ...
                                <div className="mt-5 flex justify-between items-center gap-3 dark:text-white-light/75">

                                    <label className="mb-0 inline-flex cursor-pointer hover:text-primary group">
                                        <input type="radio" checked={config.nav === 'navbar-sticky'} value="navbar-sticky" className="form-radio group-hover:!border-primary" onChange={() => dispatch(actions.toggle_nav('navbar-sticky'))}/>
                                        <span className='px-1'>{config.text.sticky}</span>
                                    </label>

                                    <label className="mb-0 inline-flex cursor-pointer hover:text-primary group">
                                        <input type="radio" checked={config.nav === 'navbar-floating'} value="navbar-floating" className="form-radio group-hover:!border-primary" onChange={() => dispatch(actions.toggle_nav('navbar-floating'))}/>
                                        <span className='px-1'>{config.text.floating}</span>
                                    </label>

                                    <label className="mb-0 inline-flex cursor-pointer hover:text-primary group">
                                        <input type="radio" checked={config.nav === 'navbar-static'} value="navbar-static" className="form-radio group-hover:!border-primary" onChange={() => dispatch(actions.toggle_nav('navbar-static'))}/>
            ...
            <div className="fixed bottom-6 z-50 ltr:right-6 rtl:left-6">
                {
                    button &&
                    <button type="button" onClick={() => document.querySelector('.main-content.overflow-x-hidden').scrollTop = 0} className="btn btn-outline-primary animate-pulse rounded-full bg-[#fafafa] p-2 dark:bg-[#060818] dark:hover:bg-primary">
